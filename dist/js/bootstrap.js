...
(function (o_o) {
  ...
  Affix.prototype.getState = function (scrollHeight, height, offsetTop, offsetBottom) {
    ...
    // When the element is affixed to the top
    if (offsetTop != null && this.affixed === 'top') {
      return scrollTop >= offsetTop ? false : 'top'

    // When the element is affixed to the bottom
    } else if (this.affixed === 'bottom') {
      // Can be affixed to the top, use unpin value
      if (offsetTop != null) {
        return (scrollTop + this.unpin <= position.top) ? false : 'bottom'
      // Can only ever pinned or affixed to the bottom, ignore unpin value
      } else {
        return (scrollTop + targetHeight <= scrollHeight - offsetBottom) ? false : 'bottom'
      }

    // When the element is pinned, or when the affix is first initialized
    } else {
